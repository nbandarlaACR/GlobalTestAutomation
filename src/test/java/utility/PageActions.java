...
public abstract class PageActions {
   ...
   private static final Integer WAIT_TIME = 500;
   ...
   protected void click(String text) {
      ...
      if (foundElems.size() == 0) {
         throw new NotFoundException("Element to be clicked not found: " + text);
      } else {
   ...
   private void clickElementAt(By locator, int atIndex) {
   ...
   public boolean selectOptionWithText(By locator, String text) {
   ...
   public void selectOptionWithValue(By locator, String value) {
      WebElement dropdown = findElement(locator);
      Select datasetOptions = new Select(dropdown);
   ...
   public WebElement waitUntilElementVisible(By locator) {
      System.out.println("Waiting Element Visibility:\t" + locator.toString());
   ...
   public boolean waitUntilElementInvisible(By locator) {
      System.out.println("Waiting Element Invisibility:\t" + locator.toString());
      highlight(locator);
   ...
   public boolean waitUntilTextPresent(By locator, String target) {
   ...
   public boolean waitUntilTextPresent(WebElement element, String target) {
      boolean result = waits.until(ExpectedConditions.textToBePresentInElement(element, target));
      highlight(element);
      return result;
   }
